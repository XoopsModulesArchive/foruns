...
define('_MD_ICQ', 'Add uin to contact list');
...
define('_MD_PM', 'Send Private Message');
...
define('_MD_PRIVATE', 'This is a <b>Private</b> forum.<br>Only users with special access can post new topics and replies to this forum');
