 ...
 *
 * $Id: admin_forums.php,v 1.2 2006/02/11 17:03:17 mikhail Exp $
 ***************************************************************************/
...
if (isset($_POST['save']) && '' != $_POST['save']) {
    if (!$_POST['delete']) {
        ...
        $sql = sprintf(
            "UPDATE %s SET forum_name = '%s', forum_desc = '%s', forum_type = '%s', cat_id = %u, forum_access = %u, allow_html = '%s', allow_sig = '%s', posts_per_page = %u, hot_threshold = %u, topics_per_page = %u WHERE forum_id = %u",
        ...
        if ($xoopsDB->getRowsNum($r) > 0) {
            ...
            while (false !== ($ids = $xoopsDB->fetchArray($r))) {
                if (true === $looped) {
                    $sql .= ' OR ';
                }
...
<form action="<?php echo $HTTP_SERVER_VARS['PHP_SELF']; ?>" method='post'>
    ...
    echo "<tr class='bg3' align='left'><td align='center' colspan='2'><input type='hidden' name='mode' value='editforum'><input type='hidden' name='forum' value='$forum'><input type='submit' name='save' value='"
                         . _MD_A_SAVECHANGES
    ...
    echo '</tr></table></td></tr></table>';
        ...
        $sql = 'SELECT * FROM ' . $xoopsDB->prefix('bb_categories') . ' ORDER BY cat_title';
                                        ...
                                        while (false !== ($m = $xoopsDB->fetchArray($r))) {
		...
		<input type='hidden' name='mode' value='<?php echo $mode ?>'></td>
                                                            ...
                                                            <tr class='bg3'>
                                                                <td align='center' colspan="2"><span class='fg2'>
		<input type="submit" name="submit" value="<?php echo _MD_A_REMOVECATEGORY; ?>"></td>
                                                            </tr>
                                                        </table>
                                            </table>
                                        </form>
                                ...
                                <form action="<?php echo $HTTP_SERVER_VARS['PHP_SELF']; ?>" method='post'>
                                    ...
                                    if (isset($_POST['submit']) && '' != $_POST['submit']) {
                                        ...
                                        $sql = 'INSERT INTO '
                                                  . $xoopsDB->prefix('bb_forums')
                                                  . " (forum_id, forum_name, forum_desc, forum_access, cat_id, forum_type, allow_html, allow_sig,posts_per_page,hot_threshold,topics_per_page) VALUES ($nextid, '$name', '$desc', $forum_access, $cat, $type, '$html', '$sig', $ppp, $hot, $tpp)";
                                    ...
                                    <form action="<?php echo $HTTP_SERVER_VARS['PHP_SELF']; ?>" method='post'>
                                        ...
                                        if ($myrow = $xoopsDB->fetchArray($result)) {
                                            ...
                                            echo '<option value="0">' . _MD_A_NONE . "</option>\n";
                                                        ...
                                                        <?php
                                                        echo "<tr class='bg1' align='left'><td><span class='fg2'>"
                                                             . _MD_A_ALLOWHTML
                                                             . "</span></td>			<td><input type='radio' name='html' value='1'>"
                                                             . _MD_A_YES
                                                             . "<input type='radio' name='html' value='0' checked >"
                                                             . _MD_A_NO
                                                             . "</td></tr>
		<tr class='bg1' align='left'><td><span class='fg2'>"
                                                             . _MD_A_ALLOWSIGNATURES
                                                             . "</span></td>
		<td><input type='radio' name='sig' value='1' checked>"
                                                             . _MD_A_YES
                                                             . "<input type='radio' name='sig' value='0'>"
                                                             . _MD_A_NO
                                                             . "</td></tr>
		<tr class='bg1' align='left'><td><span class='fg2'>"
                                                             . _MD_A_HOTTOPICTHRESHOLD
                                                             . "</span></td><td><input type='text' name='hot' size='3' maxlength='3' value='10'></td></tr>
		<tr class='bg1' align='left'><td><span class='fg2'>"
                                                             . _MD_A_POSTPERPAGE
                                                             . "</span><br><span class='fg2'><i>"
		...
		<tr class='bg1' align='left'><td><span class='fg2'>"
                                                             ...
                                                             . "</i></span></td><td><input type='text' name='tpp' size='3' maxlength='3' value='20'></td></tr>"; ?>
                                                        <tr class='bg3' align='left'>
                                                            <td align='center' colspan="2">
                                                    ...
                                                    <td class='bg2'>
                                                        <table border="0" cellpadding="1" cellspacing="1" width="100%">
                                                            ...
                                                            <tr class='bg3' align='center'>
                                                                <td><?php echo _MD_A_CATEGORY1; ?></td>
                                                                <td><?php echo _MD_A_MOVEUP; ?></td>
                                                                <td><?php echo _MD_A_MOVEDOWN; ?></td>
                                                            </tr>
                                                            <?php
                                                            ...
                                                            <td class='bg2'>
                                                                <table border="0" cellpadding="1" cellspacing="1" width="100%">
                                                                    ...
                                                                    <tr class='bg1' align='center'>
                                                                        <td>
                                                                            <form action="<?php echo $HTTP_SERVER_VARS['PHP_SELF']; ?>" method="post">
                                                                                <input type="hidden" name="mode" value="<?php echo $mode ?>"><input type="submit" name="submit" value="<?php echo _MD_A_SYNCFORUM; ?>"></form>
                                                                        </td>
                                                                        </td>
                                                                    </tr>
                                                                </table>
