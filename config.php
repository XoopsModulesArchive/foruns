...
// $Id: config.php,v 1.6 2006/03/10 17:08:37 mikhail Exp $
//  ------------------------------------------------------------------------ //
...
$bbUrl['root'] = XOOPS_URL . '/modules/foruns/';
...
setcookie('forunsLastVisit', time(), $expiredate1, $bbCookie['path'], $bbCookie['domain'], $bbCookie['secure']);
...
$temptime = $HTTP_COOKIE_VARS['forunsLastVisitTemp'] ?? $HTTP_COOKIE_VARS['forunsLastVisit'] ?? time();

// set cookie.
setcookie('forunsLastVisitTemp', $temptime, $expiredate2, $bbCookie['path'], $bbCookie['domain'], $bbCookie['secure']);
