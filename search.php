...
// $Id: search.php,v 1.5 2006/02/18 23:39:07 mikhail Exp $
//  ------------------------------------------------------------------------ //
...
if (!isset($_POST['submit'])) {
    $GLOBALS['xoopsOption']['template_main'] = 'foruns_search.html';
    ...
    $GLOBALS['xoopsOption']['template_main'] = 'foruns_searchresults.html';
    ...
    $query = 'SELECT u.uid,f.forum_id, p.topic_id, u.uname, p.post_time,t.topic_title,t.topic_views,t.topic_replies,f.forum_name FROM '
        ...
        while (false !== ($row = $xoopsDB->fetchArray($result))) {
            $xoopsTpl->append(
                ...
                [
                    ...
                    'topic_title' => htmlspecialchars($row['topic_title'], ENT_QUOTES | ENT_HTML5),
